...
const Sidebar = ({
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-teal-900 text-white">
      {/* Logo */}
      {!isCollapsed && (
      ...
      <div className="flex-1">
        <Menu
          ...
          inlineCollapsed={isCollapsed} // auto collapse icons
        />
      </div>
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-[-16px] bg-teal-900 text-white rounded-full w-6 h-6 flex items-center justify-center hover:bg-teal-800"
        >
